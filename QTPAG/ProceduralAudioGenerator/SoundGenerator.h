...
const int NUM_AVAILABLE_INSTRUMENTS = 10;
...
private:
    ...
    void Generate_Note(float frequency, double duration, float amplitude, Instruments instrument, int buffer_index, int instrument_override = -1);
...
public:
    ...
    void Generate_Music(int length = -1, int instrument_override = -1);
    ...
    void AddCustomInstrument(Instrument instrument);
};
